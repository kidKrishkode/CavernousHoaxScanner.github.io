        ...
        <div class="workspace blbg" style="background: #0000009e;" id="errorPreview">
            <div class="errorView">
                <header class="flx"><img src="../public/favicon.ico" alt="load"/>
                    <span style="cursor: pointer;" onclick="new TAB().closeAll(); system.closePyError();">&times;</span>
                </header>
                <div class="error-message">
                    ...
                    <p><|error.message|></p>
                <div class="btn btn-process" style="margin-top: 40px;" onclick="new TAB().closeAll(); system.closePyError();"><i class="fa fa-refresh"></i> Re-try</div>
            </div>
        </div>`,
    traffic: {
